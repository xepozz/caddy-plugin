...
![Build](https://github.com/xepozz/caddy-plugin/workflows/Build/badge.svg)
...
[GitHub](https://github.com/xepozz/caddy-plugin) | [Telegram](https://t.me/jb_plugins/42) | [Donation](https://github.com/xepozz/xepozz?tab=readme-ov-file#become-a-sponsor)
...
- Using the IDE built-in plugin system:
  ...
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>Marketplace</kbd> > <kbd>Search for "caddy-plugin"</kbd> >
  <kbd>Install</kbd>
...
- Manually:
  ...
  Download the [latest release](https://github.com/xepozz/caddy-plugin/releases/latest) and install it manually using
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>⚙️</kbd> > <kbd>Install plugin from disk...</kbd>
