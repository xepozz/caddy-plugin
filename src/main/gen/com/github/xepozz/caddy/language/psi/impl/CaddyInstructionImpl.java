...
public class CaddyInstructionImpl extends ASTWrapperPsiElement implements CaddyInstruction {

  public CaddyInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public CaddyDirective getDirective() {
    return findChildByClass(CaddyDirective.class);
  }
