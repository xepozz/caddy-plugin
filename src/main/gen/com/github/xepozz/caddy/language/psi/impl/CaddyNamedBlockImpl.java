...
public class CaddyNamedBlockImpl extends ASTWrapperPsiElement implements CaddyNamedBlock {

  public CaddyNamedBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public CaddyBlock getBlock() {
    return findNotNullChildByClass(CaddyBlock.class);
  }

  @Override
  @NotNull
  public CaddyBlockName getBlockName() {
    return findNotNullChildByClass(CaddyBlockName.class);
  }
