...
public class CaddyBlockImpl extends ASTWrapperPsiElement implements CaddyBlock {

  public CaddyBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CaddyInstruction> getInstructionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CaddyInstruction.class);
  }
